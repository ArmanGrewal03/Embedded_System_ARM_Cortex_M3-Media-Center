...
void TIMER0_IRQHandler(void) 
{
  ...
  LPC_TIM0->IR = 1;                         /* Clear Interrupt Flag */
	...
	GLCD_Bargraph(160, 240, 20, 200, Volume );
	uint32_t joyStickState = get_button();
...
void runMusicPlayer()
{
	// Init
	GLCD_Clear  (White);
	GLCD_DisplayString(0, 0, __FI, (unsigned char *)"Press SELECT to disable music!");
